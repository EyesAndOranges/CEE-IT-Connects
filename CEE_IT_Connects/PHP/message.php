...
// CHANGED update required hours for CE/EE/IT programs
...
$rhStmt = $pdo->prepare("
    SELECT rh.required_hours 
    FROM required_hours rh
    JOIN students s ON s.program = rh.program
    WHERE s.id = ?
");
$rhStmt->execute([$_SESSION['user_id']]);
$requiredHours = $rhStmt->fetchColumn() ?: 486;

// var_dump($requiredHours); exit;
