...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=DM+Sans:ital,opsz,wght@0,9..40,300;0,9..40,400;0,9..40,500;0,9..40,600;0,9..40,700;1,9..40,300&family=Fraunces:ital,opsz,wght@0,9..144,300;0,9..144,600;1,9..144,300&display=swap" rel="stylesheet">
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .btn-clear-filters:hover { background: #111826; color: #fff; }
        ...
        .detail-val a { color: var(--orange); text-decoration: none; }
        ...
        .file-name i { color: var(--orange); font-size: .8rem; }
        .file-btns {
            display: flex;
            gap: 6px;
            flex-shrink: 0;
        ...
        .btn-dl:hover { background: #d94c10; color: #fff; }
        ...
        .empty-state i { font-size: 2.5rem; margin-bottom: 14px; color: var(--border); }
...
<body>
                    ...
                    <form method="GET" id="filter-form">
                        <div class="sidebar-card">
                            ...
                            <div class="search-wrap">
                                ...
                                <input type="text" id="search-internship"
                ...
                <div class="col-lg-9">
                    ...
                    <div class="internship-mobile-header">
                        <div style="position: relative; flex: 1; min-width: 0;">
                            <i class="fa fa-search" style="position: absolute; left:12px; top: 50%; transform: translateY(-50%); color: #aaa; z-index: 1;"></i>
                    ...
                    <div class="listing-card"
                        ...
                        <div class="card-actions">
                            <button class="btn-readmore" onclick="togglePanel('details', <?= $internship['id'] ?>, this)">
                                <i class="fa fa-circle-info"></i> Read More
                            </button>
                            <button class="btn-interested" onclick="togglePanel('files', <?= $internship['id'] ?>, this)">
                                <i class="fa fa-file-arrow-down"></i> Interested
                            </button>
                        </div>

                        <!-- ── Read More: Company Deets ── -->
                        <div class="details-panel" id="details-<?= $internship['id'] ?>">
                            ...
                            <div class="details-grid">
                                ...
                                <div class="detail-row">
                                    ...
                                    <span class="detail-val"><?= $internship['internship_type'] === 'paid' ? 'With stipend' : 'Without stipend' ?></span>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="detail-row">
                                    ...
                                    <span class="detail-val"><?= htmlspecialchars($internship['company_classification']) ?></span>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="detail-row">
                                    ...
                                    <span class="detail-val"><?= htmlspecialchars($internship['phone_numbers']) ?></span>
                                </div>
                                <?php endif; ?>
                        ...
                        <!-- ── Interested: Download Files ── -->
                        <div class="files-panel" id="files-<?= $internship['id'] ?>">
                            <p class="files-panel-title">Application Documents</p>
    ...
    <script>
        // ── Mutual exclusivity: one panel open per card at a time ──
        function togglePanel(type, id, btn) {
            const card = btn.closest('.listing-card');
            const detailsPanel = card.querySelector('.details-panel');
            const filesPanel   = card.querySelector('.files-panel');
            const readBtn      = card.querySelector('.btn-readmore');
            const intBtn       = card.querySelector('.btn-interested');
            ...
            if (type === 'details') {
                ...
                const isOpen = filesPanel.classList.contains('open');
                detailsPanel.classList.remove('open');
                filesPanel.classList.remove('open');
                readBtn.classList.remove('active');
                intBtn.classList.remove('active');
        ...
        function applyFilters() {
            ...
            document.querySelectorAll('.listing-card').forEach(card => {
                ...
                // if (deadline) {
                //     const dlEl   = card.querySelector('[data-deadline]');
                //     const dlStr  = dlEl ? dlEl.dataset.deadline : '';
                ...
                const show = matchSearch && matchType && matchClass;
        ...
        // Program filter: submit form (server-side)
