        ...
        <div class="navbar-icons d-flex align-items-center position-relative">
            ...
            <div class="profile-wrapper">
                ...
                <div class="profile-drop" id="profileDrop">
                    ...
                    <a onclick="openHelpModal()" class="logout" style="margin-top:6px;color:#2255cc;cursor:pointer;display:flex;align-items:center;gap:6px;justify-content:center;">
                        Help &amp; Guide
                    </a>
            ...
            <!-- ===================== HELP MODAL ===================== -->
            <div id="helpModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.45);align-items:flex-start;justify-content:center;padding-top:40px;">
                <div style="background:#fff;border-radius:16px;width:min(720px,95vw);max-height:85vh;display:flex;flex-direction:column;overflow:hidden;">

                    <!-- Header -->
                    <div style="display:flex;align-items:center;justify-content:space-between;padding:22px 28px 18px;border-bottom:1.5px solid #e8eaf0;flex-shrink:0;">
                        <div style="display:flex;align-items:center;gap:12px;">
                            <div style="width:40px;height:40px;border-radius:10px;background:#eef1ff;display:flex;align-items:center;justify-content:center;">
                        ...
                        <button onclick="closeHelpModal()" style="border:none;background:none;cursor:pointer;font-size:22px;color:#aaa;line-height:1;padding:4px 8px;">&times;</button>
                    </div>
                    ...
                    <div style="overflow-y:auto;padding:24px 28px;flex:1;">
                        ...
                        <?php
                        $sections = [
                            ['bi-funnel-fill','View Internship Listings',[
                            ...
                            ['bi-info-circle-fill','View Opportunity Details',[
                            ...
                            ['bi-hand-thumbs-up-fill','Express Interest in an Internship',[
                            ...
                            ['bi-file-earmark-text-fill','View Internship Documentation',[
                            ...
                            ['bi-file-earmark-arrow-down-fill','Generate Automated Documents',[
                            ...
                            ['bi-geo-alt-fill','View Map & Locate Partner Institutions',[
                            ...
                            ['bi-person-lines-fill','Submit Academic & Personal Information',[
                            ...
                            ['bi-chat-dots-fill','Message a User',[
                        ...
                        <div style="margin-bottom:16px;border:1px solid #e8eaf0;border-radius:12px;overflow:hidden;">
                            <div style="background:#f4f6ff;padding:11px 16px;display:flex;align-items:center;gap:9px;border-bottom:1px solid #e8eaf0;">
                                <i class="bi <?= $icon ?>" style="color:#272f54;font-size:15px;flex-shrink:0;"></i>
                                <span style="font-weight:700;font-size:13.5px;color:#272f54;"><?= $title ?></span>
                            </div>
                            <div style="padding:12px 16px;">
                                <ol style="margin:0;padding-left:18px;">
                                    <?php foreach ($steps as $step): ?>
                                    <li style="font-size:13px;color:#444;line-height:1.7;margin-bottom:2px;"><?= $step ?></li>
                                    <?php endforeach; ?>
                                </ol>
                            </div>
                        </div>
                        ...
                        <?php
                        $sections = [
                            ['bi-grid-fill','Create & Manage Virtual Rooms',[
                            ...
                            ['bi-people-fill','Add Participants to a Room',[
                            ...
                            ['bi-clock-history','Monitor Rendered OJT Hours & Remarks',[
                            ...
                            ['bi-megaphone-fill','Post Announcements',[
                                'Open the room where you want to post and type in the text box.',                                'Enter a title and compose your message using the text editor.',
                                'Click <strong>Post Announcement</strong> to publish to all room participants.',
                            ]],
                            ['bi-chat-left-text-fill','Communicate with HTE Advisers and Students',[
                        ...
                        <div style="margin-bottom:18px;">
                            <div style="font-size:15px;font-weight:700;color:#272f54;margin-bottom:4px;">
                                <i class="bi bi-building" style="margin-right:6px;"></i>HTE Adviser User Guide
                            </div>
                            <p style="font-size:13px;color:#666;margin:0;line-height:1.6;">
                                As an HTE Adviser, you are the on-site supervisor at the Host Training Establishment. Your main responsibilities involve evaluating students and updating their progress.
                            </p>
                        </div>
                        <?php
                        $sections = [
                            ['bi-pencil-square','Submit Remarks & Feedback on Students',[
                            ...
                            ['bi-stopwatch-fill','Confirm Student Rendered OJT Hours',[
                            ...
                            ['bi-chat-dots-fill','Communicate with Students & OJT Advisers',[
                                'Go to the <strong>Chats</strong> section.',
                        ...
                        <?php
                        $sections = [
                            ['bi-briefcase-fill','Post Internship Opportunities',[
                            ...
                            ['bi-eye-fill','Monitor Students Who Expressed Interest',[
                            ...
                            ['bi-card-checklist','Track Student Applications & Documentation',[
                        ...
                        <div style="margin-bottom:18px;">
                            <div style="font-size:15px;font-weight:700;color:#272f54;margin-bottom:4px;">
                                <i class="bi bi-shield-lock-fill" style="margin-right:6px;"></i>System Admin User Guide
                            </div>
                            <p style="font-size:13px;color:#666;margin:0;line-height:1.6;">
                                As a System Admin, you have full platform oversight — managing users, monitoring all activity, and ensuring system integrity and compliance.
                            </p>
                        </div>
                        <?php
                        $sections = [
                            ['bi-bar-chart-line-fill','Monitor Overall Internship Activities',[
                            ...
                            ['bi-person-gear','Create Admin, Adviser, and Student Accounts',[
                            ...
                            ['bi-people-fill','Change Roles of All Admin Accounts',[
                            ...
                            ['bi-layout-text-sidebar-reverse','Access All User Activities and Actions',[
                        ...
                        <div style="margin-top:10px;background:#fff8f0;border:1px solid #ffd8a8;border-radius:12px;padding:14px 18px;display:flex;align-items:flex-start;gap:12px;">
                            <i class="bi bi-box-arrow-right" style="color:#c46a00;font-size:20px;margin-top:1px;flex-shrink:0;"></i>
                            <div>
                                <div style="font-weight:700;font-size:13.5px;color:#7a3f00;margin-bottom:4px;">Logging Out</div>
                                <ol style="margin:0;padding-left:18px;">
                                    <li style="font-size:13px;color:#a05500;line-height:1.7;">Click your <strong>profile icon</strong> at the top-right corner of the page.</li>
                                    <li style="font-size:13px;color:#a05500;line-height:1.7;">The profile dropdown will appear with your name and email.</li>
                                    <li style="font-size:13px;color:#a05500;line-height:1.7;">Click <strong>Log Out?</strong> at the bottom of the dropdown.</li>
                                    <li style="font-size:13px;color:#a05500;line-height:1.7;">You will be redirected to the login page. Always log out on shared or public devices.</li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <!-- Footer -->
                    <div style="padding:16px 28px;border-top:1.5px solid #e8eaf0;display:flex;justify-content:flex-end;flex-shrink:0;">
                        <button onclick="closeHelpModal()" style="padding:9px 24px;border-radius:8px;border:1px solid #d0d3e0;background:#fff;color:#272f54;font-size:13px;font-weight:700;cursor:pointer;">Close</button>
                    </div>
                </div>
            </div>
