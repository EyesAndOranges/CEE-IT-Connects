...
.btn-search { background:#272f54; color:#fff; font-weight:600; }
</style>
</head>
<body>
...
<div class="filter-box">
  ...
  <div class="mb-3">
    ...
    <div class="form-check"><input class="form-check-input" type="radio" name="sort"> All scholarship listings</div>
    <div class="form-check"><input class="form-check-input" type="radio" name="sort"> Civil Engineering</div>
    <div class="form-check"><input class="form-check-input" type="radio" name="sort"> Electrical Engineering</div>
    <div class="form-check"><input class="form-check-input" type="radio" name="sort"> Information Technology</div>
  </div>
  ...
  <div class="mb-3">
    ...
    <div class="form-check"><input class="form-check-input" type="radio" name="deadline"> Upcoming (future deadlines)</div>
  </div>
...
<div class="listing-card mt-3">
    ...
    <p class="mb-3">Financial assistance for eligible tertiary students enrolled in CHED-recognized institutions.</p>
