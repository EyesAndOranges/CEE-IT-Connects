        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 hero-content">
                ...
                <div class="welcome-overlay animate-on-scroll animate-scale">
                    ...
                    <h1 class="main-heading animate-on-scroll animate-right">
                        CEE IT Connects
                    </h1>
        ...
        <div class="row g-5 mt-2">
            ...
            <div class="col-md-4">
                <div class="feature-item animate-on-scroll animate-scale">
                    ...
                    <p>
                        Find internship opportunities tailored to your program, qualifications,
                        and preferred location through powerful filtering and automated listings.
                    </p>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="feature-item animate-on-scroll animate-scale">
                    ...
                    <p>
                        Track your application status from submission to approval with
                        instant updates and automated notifications.
                    </p>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="feature-item animate-on-scroll animate-scale">
                    ...
                    <p>
                        Advisers and HTE supervisors can monitor progress, evaluations,
                        and internship logs through a structured virtual workspace.
                    </p>
                </div>
            </div>
...
<span class="status" data-hours="9-21">OPEN</span>
</h3>

<div class="menu-container">

<i class="fas fa-ellipsis-v menu-icon" onclick="toggleMenu(this)"></i>

<div class="color-menu">

<div onclick="changeMarkerColor(<?= $loc['id'] ?>,'red')" style="background:red"></div>
<div onclick="changeMarkerColor(<?= $loc['id'] ?>,'blue')" style="background:blue"></div>
<div onclick="changeMarkerColor(<?= $loc['id'] ?>,'green')" style="background:green"></div>
<div onclick="changeMarkerColor(<?= $loc['id'] ?>,'yellow')" style="background:yellow"></div>
...
<p>
<?= htmlspecialchars($loc['address'] ?? $loc['location']) ?>
</p>
...
<!-- about D gumagana ung animations?? But WHY????-->
...
<div class="col-md-4 brand-center">
...
©2026 CEE IT Connects. All rights reserved
</div>
...
<div style="padding:4px 0;cursor:pointer;" onclick="copyNumber('${num.trim()}')">
${num.trim()}
</div>
`).join('');
...
markers[id].setIcon(`http://maps.google.com/mapfiles/ms/icons/${color}-dot.png`);
    ...
    const observer = new IntersectionObserver((entries) => {
        entries.forEach(entry => {
            if(entry.isIntersecting){
                ...
                entry.target.classList.remove('visible'); // fade out when scroll
            }
        });
    }, observerOptions);
