...
switch ($action) {
    case 'mou':
        ...
        $filename = "MOU_" . $data['student_name'] . ".pdf";
    ...
    case 'rl':
        ...
        $filename = "Recommendation_Letter_" . $data['student_name'] . ".pdf";
        $pdf->Output("D", $filename);
        exit;
        break;
    case 'waiver':
        ...
        $filename = "Waiver_" . $data['student_name'] . ".pdf";
        $pdf->Output("D", $filename);
        exit;
        break;
    default:
