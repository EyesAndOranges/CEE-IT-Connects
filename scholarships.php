...
<body>
    ...
    <div class="main-content">
        ...
        <div class="scholarship-header-card">
            <h2>Scholarships</h2>
            <p>Manage the CEE IT Connects scholarship applications</p>
        </div>
        ...
        <div class="scholarship-table">
            ...
            <div class="table-row">
                <div class="td-title">CHED Tertiary Education Subsidy</div>
                <div class="td-company">CHED</div>
            ...
            <div class="table-row">
                <div class="td-title">Kuya Win Scholarship Program</div>
                <div class="td-company">Valenzuela City</div>
                <div class="td-applicant">Juan Leandro Seleno</div>
                <div class="td-actions">
                    <button class="action-btn">
                        <img width="16" height="16" src="edit.png">
                    </button>
            ...
            <div class="table-row">
                <div class="td-title">Scholarship Title</div>
                <div class="td-company">Company Name</div>
